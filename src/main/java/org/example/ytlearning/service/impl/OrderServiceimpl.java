...
import org.example.ytlearning.exception.BadErrorRequestException;
import org.example.ytlearning.exception.InternalServerErrorException;
import org.example.ytlearning.exception.UserNotFoundErrorException;
import org.example.ytlearning.model.*;
import org.example.ytlearning.repository.*;
...
public class OrderServiceimpl implements OrderService {
    ...
    public OrderResponse create(OrderRequest orderRequest) {
        ...
        if(verifyOrderPending.isPresent()) {
            ...
            throw new BadErrorRequestException("User has pending order.");
        }
        ...
        List<DeliveryPartner> deliveryPartners = deliveryPartnerRepository.findAllByAvailable(false);
        ...
        if(orderRequest.getOrderItemRequests().isEmpty()) {
            ...
            throw new BadErrorRequestException("Order items required non-null.");
        }
        ...
        payment.setCreateBy(user.get().getUsername());
